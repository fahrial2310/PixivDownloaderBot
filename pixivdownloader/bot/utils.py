...
from pixivdownloader.bot import settings
...
class Utils:
    ...
    def __init__(self):
        ...
        main_bot.add_command(name='chat', func=self.get_chat_command, admins_only=True)
        main_bot.add_command(name='settings', func=self.runtime_settings_command, admins_only=True)
